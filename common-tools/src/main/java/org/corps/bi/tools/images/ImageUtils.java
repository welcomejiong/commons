...
public final class ImageUtils {
	...
	public final static void pressImage(String targetImg, String waterImg,
		...
		try {
			...
			String formatName = ImageCutterUtil.getImageFormatName(iis);
			if (formatName.equalsIgnoreCase(PICTRUE_FORMATE_JPEG)) {
				formatName = PICTRUE_FORMATE_JPG;
			}
	...
	public static void main(String[] args) throws IOException {
		pressImage("D:\\14436K62fjpyRFW.jpg", "D:\\water.png", 5000, 5000, 0.2f);
