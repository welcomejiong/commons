...
public class JSONUtils {
	...
	static{
		...
		ignoreUnknownPropertiesObjectMapper.configure(JsonParser.Feature.ALLOW_UNQUOTED_FIELD_NAMES, true);
		ignoreUnknownPropertiesObjectMapper.configure(JsonParser.Feature.ALLOW_UNQUOTED_CONTROL_CHARS, true);
		ignoreUnknownPropertiesObjectMapper.configure(JsonParser.Feature.ALLOW_SINGLE_QUOTES, true);
