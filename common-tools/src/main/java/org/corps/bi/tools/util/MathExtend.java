...
public class MathExtend {
	 ...
	 * @return
	 */
	public static float discount(String v1, String v2) {
		BigDecimal b1 = new BigDecimal(v1);
		BigDecimal b2 = new BigDecimal(v2);

		BigDecimal b3 = b1.divide(b2, 2, BigDecimal.ROUND_HALF_EVEN);

		return b3.divide(ZERO_POINT_ONE, 1, BigDecimal.ROUND_HALF_EVEN)
				.floatValue();
	}
	 ...
	 * @return
	 */
	public static String percentage(String v) {
		return divide(v, HUNDRED, DEFAULT_DIV_SCALE);
	}
